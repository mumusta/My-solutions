...
int main() {
   // ______________________________________________________________________
    ...
    for (int i = 0 ; i < n ; i ++){
        ...
        point a = read_point(); point b = read_point();
        point c = read_point(); point d = read_point();
        line l1(a, b); line l2(c, d); point in;

        if (intersectLines(a, b, c, d, in))
            cout << fixed << sp(2) << "POINT " << in.X << " " << in.Y << endl;
        else {
