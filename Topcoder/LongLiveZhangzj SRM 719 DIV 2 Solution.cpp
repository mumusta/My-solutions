...
public:
	int donate(vector <string> speech, vector <string> words) {
		set < string > st; int n = speech.size(), m = words.size();
        for (int i = 0 ; i < m; i ++)
            st.insert(words[i]);
        int res = 0;
        for (int i = 0 ; i < n; i ++){
            auto it = st.find(speech[i]);
            if (it != st.end()) res++;
        }
        return res;
	}
...
int main() {
	...
	{
	// ----- test 0 -----
	string t0[] = {"make","topcoder","great","again"};
			p0.assign(t0, t0 + sizeof(t0) / sizeof(t0[0]));
	string t1[] = {"make","america","great","again"};
	...
	{
	// ----- test 3 -----
	string t0[] = {"je","le","ai","deja","vu","et","je","le","veux","encore"};
			p0.assign(t0, t0 + sizeof(t0) / sizeof(t0[0]));
	string t1[] = {"i","am","having","deja","vu","please","stop","the","encore"};
			p1.assign(t1, t1 + sizeof(t1) / sizeof(t1[0]));
	p2 = 3;
