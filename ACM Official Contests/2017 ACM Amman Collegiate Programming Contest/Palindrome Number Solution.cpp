...
int main() {
  //  ______________________________________________________________________
    ...
    for (int tt = 0; tt < t; tt ++){
        ...
        int n, s; cin >> n >> s; vector < int > seq(n);
        ...
        if (n % 2 == 0){
            if (s % 2 == 0){
                for (int i = 0, ii = (n - 1); (i < (n / 2)) && (s > 0); i++, ii--){
                    if (s >= 18) seq[i] = seq[ii] = 9, s-= 18;
                    else seq[i] = seq[ii] = (s / 2), s = 0;
                } prrr(seq);
            }
            else cout << -1 << endl;
        }
            ...
            if (s % 2 == 0){
                ...
                for (int i = 0, ii = (n - 1); (i < (n / 2)) && (s > 1); i++, ii--){
                    if (s >= 18) seq[i] = seq[ii] = 9, s-= 18;
                    else { seq[i] = seq[ii] = ((s - 1) / 2); s = 1; break; }
                } seq[n / 2] = s; prrr(seq);
            }
        }
    }
